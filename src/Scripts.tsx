...
export const induction = `This <break=1> file <fontsize=5vw> is designed to 
<log=4,break=2> help you enter  trance. <halt=1,fontsize=10vw> It's going to help train you <wpm=200>
