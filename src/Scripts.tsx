...
export const induction = `This file <halt=1,fontsize=5vw> is designed to <log=4> help you enter  trance. <halt=1,fontsize=10vw> It's going to help train you <wpm=400>
